...
;; note, hardlinked...
(load-file "~/config/emacs.d/package.el") ;; needed by rest of sub-modules
(load-file "~/config/emacs.d/my.el")      ;; needed for some sub-modules
...
(load-file "~/config/emacs.d/email.el")
